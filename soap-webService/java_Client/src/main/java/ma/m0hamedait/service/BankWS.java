 ...
 * 
 */
@WebServiceClient(name = "BankWS", targetNamespace = "http://ws.m0hamedAit.ma/", wsdlLocation = "http://localhost:9191/BankWS?wsdl")
public class BankWS
    extends Service
{
    ...
    private final static QName BANKWS_QNAME = new QName("http://ws.m0hamedAit.ma/", "BankWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9191/BankWS?wsdl");
    ...
    public BankService getBankServicePort() {
        return super.getPort(new QName("http://ws.m0hamedAit.ma/", "BankServicePort"), BankService.class);
    }
    ...
    public BankService getBankServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.m0hamedAit.ma/", "BankServicePort"), BankService.class, features);
    }
